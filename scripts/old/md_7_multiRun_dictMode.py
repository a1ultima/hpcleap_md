...
for simulation in range(0,1):
	...
	file_x 	= open("data_x_K"+str(NSTEP)+"_dt"+str(dt)+"_L"+str(L)+".txt","w") # "_t"+str(time.time())
	file_y 	= open("data_y_K"+str(NSTEP)+"_dt"+str(dt)+"_L"+str(L)+".txt","w") # "_t"+str(time.time())
	file_z 	= open("data_z_K"+str(NSTEP)+"_dt"+str(dt)+"_L"+str(L)+".txt","w") # "_t"+str(time.time())
	file_vx = open("data_vx_K"+str(NSTEP)+"_dt"+str(dt)+"_L"+str(L)+".txt","w") # "_t"+str(time.time())
	file_vy = open("data_vy_K"+str(NSTEP)+"_dt"+str(dt)+"_L"+str(L)+".txt","w") # "_t"+str(time.time())
	file_vz = open("data_vz_K"+str(NSTEP)+"_dt"+str(dt)+"_L"+str(L)+".txt","w") # "_t"+str(time.time())
	file_fx = open("data_fx_K"+str(NSTEP)+"_dt"+str(dt)+"_L"+str(L)+".txt","w") # "_t"+str(time.time())
	file_fy = open("data_fy_K"+str(NSTEP)+"_dt"+str(dt)+"_L"+str(L)+".txt","w") # "_t"+str(time.time())
	file_fz = open("data_fz_K"+str(NSTEP)+"_dt"+str(dt)+"_L"+str(L)+".txt","w") # "_t"+str(time.time())
